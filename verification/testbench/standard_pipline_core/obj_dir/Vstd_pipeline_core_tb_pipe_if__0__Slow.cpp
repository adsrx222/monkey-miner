...
VL_ATTR_COLD void Vstd_pipeline_core_tb_pipe_if___ctor_var_reset(Vstd_pipeline_core_tb_pipe_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vstd_pipeline_core_tb_pipe_if___ctor_var_reset\n"); );
    ...
    VL_ZERO_RESET_W(256, vlSelf->__Vdly__data);
}
