...
VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___eval_static(Vstd_pipeline_core_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___eval_initial__TOP(Vstd_pipeline_core_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___eval_initial__TOP\n"); );
    Vstd_pipeline_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    // Body
    __Vfunc_sum1__11__Vfuncout = 0x3587272bU;
    ...
    __Vfunc_sum0__15__Vfuncout = 0xce20b47eU;
...
VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___eval_final(Vstd_pipeline_core_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___eval_final\n"); );
    Vstd_pipeline_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vstd_pipeline_core_tb___024root___eval_phase__stl(Vstd_pipeline_core_tb___024root* vlSelf);

VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___eval_settle(Vstd_pipeline_core_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___eval_settle\n"); );
    Vstd_pipeline_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
#ifdef VL_DEBUG
            Vstd_pipeline_core_tb___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("std_pipeline_core_tb.sv", 5, "", "Settle region did not converge after 100 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
    } while (Vstd_pipeline_core_tb___024root___eval_phase__stl(vlSelf));
}

VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___eval_triggers__stl(Vstd_pipeline_core_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___eval_triggers__stl\n"); );
    Vstd_pipeline_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vstd_pipeline_core_tb___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vstd_pipeline_core_tb___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD void Vstd_pipeline_core_tb___024root___stl_sequent__TOP__0(Vstd_pipeline_core_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstd_pipeline_core_tb___024root___stl_sequent__TOP__0\n"); );
    Vstd_pipeline_core_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
